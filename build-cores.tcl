# ==================================================================================================
# Script for generating all of Pavel Demin's IP cores.
#
# Script should be ran in Ubuntu from the RedPitaya-DSP folder: vivado -mode batch -source build-cores.tcl
#
